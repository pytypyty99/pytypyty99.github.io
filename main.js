...
const initiallyDisplayedCurrencies = [ "EUR", "USD", "GBP", "JPY", "RON"];
let baseCurrency;
...
let currencies = [
    ...
    },
    {
        ...
        abbreviation: "EUR",
        symbol: "\u20AC",
        flagURL: "https://www.senojflags.com/images/national-flags/European-Union-Flag.gif",
      },
      {
        name: "Japanese Yen",
        abbreviation: "JPY",
...
window.onclick = function(event){
  ...
  addCurrencyBtn.classList.remove("open");
